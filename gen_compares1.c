...
int main(int argc,char **argv)
{
  ...
  for (m = 0; m < NUM_LEFT_TOPS - 1; m++) {
    for (n = m + 1; n < NUM_LEFT_TOPS; n++) {
      printf("compare_26_2 -debug -verbose 2b 3b 4b 5b 6b 7b 8b 9b Tb Jb Qb Kb Ab 2r 3r 4r 5r 6r 7r 8r 9r Tr Jr Qr Kr Ar %d %d %d %d > compare_26_2_debug_verbose_%d_%d_%d_%d.out\n",
